Zepto(function($){	
	//$('#btn_share').on('click',function(){alert(share())});
...
function share(){
	...
	var oCon = $('<ul class="zt_shareUl clearfix"><li><a href="javascript:void(0);"><img src="images/share_xiangce.png" /><p>保存到相册</p></a></li><li><a href="javascript:void(0);"><img src="images/share_weixinfriend.png" /><p>微信朋友圈</p></a></li><li><a href="javascript:void(0);"><img src="images/share_weixinhaoyou.png"/><p>微信好友</p></a></li><li><a href="javascript:void(0);"><img src="images/share_qq.png" /><p>QQ好友</p></a></li><li><a href="javascript:void(0);"><img src="images/share_sina.png" /><p>新浪微博</p></a></li><li><a href="javascript:void(0);"><img src="images/share_qqZone.png"/><p>QQ空间</p></a></li></ul>');	
	oHead.append(oClose);
	oWrap.append(oHead);
	oWrap.append(oCon);
	oBody.append(oMask);
